...
<div class="bg-gradient-to-b from-[#101212] to-[#08201D] h-screen min-h-screen">
        ...
        <div class="px-4 mx-auto sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 lg:h-20">
                ...
                <div class="hidden lg:flex lg:items-center lg:justify-center lg:space-x-10">
                    <a href="https://github.com/gitnjole/e-charge-tracker" title="" target="_blank" class="text-base text-white transition-all duration-200 hover:text-opacity-80"> Github </a>
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20">
            <div class="max-w-xl mx-auto text-center">
                <h1 class="text-4xl font-bold sm:text-6xl">
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-white"> Electronic charge tracker cards </span>
                </h1>
                <p class="mt-5 text-base text-white sm:text-xl">No more hassle checking your card status, check your current status and past charges here!</p>

                <a href="/cards/search" title="" class="inline-flex items-center px-6 py-4 mt-8 font-semibold text-white transition-all duration-200 bg-blue-600 rounded-lg sm:mt-16 hover:bg-blue-700 focus:bg-blue-700" role="button">
                    Check now
                ...
                <div class="grid grid-cols-1 px-20 mt-12 text-left gap-x-12 gap-y-8 sm:grid-cols-3 sm:px-0">
                    <div class="flex items-center">
                        ...
                        <p class="ml-3 text-sm text-white">Over 50 stores available</p>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <p class="ml-3 text-sm text-white">No charges for checking</p>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <p class="ml-3 text-sm text-white">"Safe"</p>
                    </div>
                </div>
            </div>
        </div>
